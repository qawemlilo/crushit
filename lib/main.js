    ...
    loadScripts: function (script) {
        ...
        if (script.type === 'inline') {
            ...
            */
            ...
            /*
                Compiling modernizr is not desirable because is goes to the header section of the page.
                Usually I prefer placing all my scripts at the bottom of the html page for optimisation purposes.
                
                This is not a reliable way to check if the file is modernizr because some developers may change the name
                of the original file. In my case its adequate
            */
