        ...
        if (self.raw) {
            if(self.minify) {
                uglify.jsmin(self.raw, function (err, smashed) {
                    if (err) {
                        ...
                        fs.writeFile(self.production, smashed, self.encoding, function () {
                            console.log('==========================================================');
                            console.log('Success!! Scripts(minified) saved in ' + self.fileName(self.development));
                            console.log('==========================================================');
                        });
                    }
                });
                ...
                fs.writeFile(self.development, self.raw, self.encoding, function () {
                    console.log('==========================================================');
                    console.log('Success!! Scripts(un-minified) saved in ' + self.fileName(self.development));
                    console.log('==========================================================');
                });
            }
        }
