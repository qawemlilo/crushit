...
crushIt = Object.create({
    ...
    */     
    init: function (opts) {
        ...
        if (!website) {
            self.onComplete('Error, you need to specify a web page resource', '');
            ...
            if (!err && response.statusCode === 200) {
                ...
                $('script').each(function () {
                    ...
                    if (src) {
                        ...
                        console.log(' found external script(' + i + ') - ' + self.getFileName(src));
                    } 
                    else {
    ...
    */       
    loadScripts: function () {
        ...
        if (!(self.scripts.length > 0)) {
            ...
            return self.onComplete(null, code); // we dont, we are done
        }
        ...
        // script in a file
            ...
            self.loadScript(script.data, function (error, js) {
                if (!error) {
                    ...
                    self.onComplete('Error!! Failed to load ' + script.data);               
                }
            });
        }
