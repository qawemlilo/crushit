...
!function(window) {
    ...
    function inspectLinks() {
        var links = document.getElementsByTagName("a"), i, href, isInternalLink, mysite = window.location.href;
        isInternalLink = function(href, link) {
            var hrefParser = document.createElement("a"), linkParser = document.createElement("a");
